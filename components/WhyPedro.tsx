  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          pedoro is not just dfsdfsf a coin isn't just another pump.shit coin.
          It's the quirky, dsasadasd-powered token built on Solana to bring
          memes and utility together for the long haul. 🚀🐒
        </p>
      </div>
